...
var getHTML = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, html, $, $selector;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get('https://lotto.postjung.com/')];
            case 1:
                response = _a.sent();
                html = response.data;
...
server.get('/lotto', function (request, reply) {
    getHTML().then(function (r) {
        reply.send(r);
